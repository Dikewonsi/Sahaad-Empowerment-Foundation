...
<head>
    ...
    <meta name="description" content="EssenceProHomes - Real Estate HTML5 Template">
    ...
    <title>EssenceProHomes - Change Password</title>
    <!-- Favicon -->
                                ...
                                <div class="col">
                                    <div class="border rounded bg-white p-30 mb-30">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-10">
                                                <form action="code.php" class="form-boder" method="POST">
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-20">
                                                            <label class="mb-2 font-fifteen">Old Password</label>
                                                            <input class="form-control" name="old_pass" type="password">
                                                        </div>
                                                        <div class="col-lg-6 mb-20">
                                                            <label class="mb-2 font-fifteen">New Password</label>
                                                            <input class="form-control" name="new_pass" type="password">
                                                        </div>
                                                        <div class="col-lg-6 mb-20">
                                                            <label class="mb-2 font-fifteen">Confirm New Password</label>
                                                            <input class="form-control" name="con_pass" type="password">
                                                        </div>
                                                        <div class="col-lg-12 mb-20">
                                                            <button type="submit" name="update_admin_btn" class="btn btn-primary">Update Password</button>
                                                        </div>
                                                    </div>
                                                </form>                                                
                                            </div>
