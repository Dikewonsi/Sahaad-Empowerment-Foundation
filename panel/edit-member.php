...
<head>
    ...
    <title>Sahaad Empowerment Foundation - Edit Members</title>
    <!-- Favicon -->
                                            ...
                                            <table class="w-100 items-list bg-transparent">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-member-page.php?id=<?= $rows['id']; ?>" class="text-primary me-4 mb-1"><i class="fas fa-edit"></i></a>
                                                        </td>
                                                    </tr>  
                                                    <?php
                                                        }
