...
<head>
    ...
    <title>Sahaad Empowerment Foundation - Add Charity Project</title>
    <!-- Favicon -->
                ...
                <div class="col-md-8 col-lg-9 col-xl-10 px-0 dashboard-body" style="height: 100vh; overflow-y: scroll;">
                    ...
                    <div class="full-row px-40 py-30 xs-p-0">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col">
                                    <h3 class="my-3">Add New Charity Project</h3>
                                </div>
                            </div>
                                        ...
                                        <div class="border rounded bg-white p-30">
                                            ...
                                            <div class="row">                                             
                                                ...
                                                <div class="col-md-6 mb-20">
                                                    <label class="mb-2 font-fifteen font-500">Location</label><span></span>
                                                    <input class="form-control" name="location" type="text" required>
                                                </div>
                                                <div class="col-md-6 mb-20">
                                                    <label class="mb-2 font-fifteen font-500">Project Date</label><span> </span>
                                        ...
                                        <div class="border rounded bg-white p-30">
                                            ...
                                            <div class="row">                                                                                                                                                        
                                                <div class="col-lg-3 col-md-6 mb-20">
                                                    ...
                                                    <input class="form-control" id="areasize" type="file" name="images[]" multiple required>
                                                </div>                                                                                                                                                                                                
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12">
                                                <button type="submit" name="add_new_project" class="btn btn-primary">Add New Project</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
