...
<head>
    ...
    <title>Sahaad Empowerment Foundation - Add Photo to Gallery</title>
    <!-- Favicon -->
                ...
                <div class="col-md-8 col-lg-9 col-xl-10 px-0 dashboard-body" style="height: 100vh; overflow-y: scroll;">
                    ...
                    <div class="full-row px-40 py-30 xs-p-0">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col">
                                    <h3 class="my-3">Add New Photo(s)</h3>
                                </div>
                            </div>
                                        ...
                                        <div class="border rounded bg-white p-30">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3 col-md-6 mb-20">
                                                    <label class="mb-2 font-fifteen font-500">Type</label>
                                                ...
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    <button type="submit" name="add_new_photo" class="btn btn-primary">Add New Photo</button>
                                                </div>                                                                                                                                          
                                            </div>                                        
                                        </div>
                                    </div>
                                    ...
                                    <div class="border rounded bg-white p-30">
                                        ...
                                        ?>  
                                            <div class="row">
                                                ...
                                                ?>
                                                            <div class="col-sm-3">
                                                                <img style="width:100px;" src="gallery/<?= $data['image']; ?>">
                                                                <p>Category: <strong><?= $data['type']; ?></strong></p>
                                                            </div>
                                                <?php
                                                        }
                                                    }
                                        ...
                                        <?php
                                            ...
                                            {
                                        ?>  
                                            <p>Nothing to show in your gallery.</p>
                                        <?php
                                            }
                                        ?> 
                                    </div>
