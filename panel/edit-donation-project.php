                                                ...
                                                <div class="border rounded bg-white p-30">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-20">
                                                            ...
                                                            <textarea class="form-control" name="descrip" required rows="10"><?= $data['description']; ?></textarea>
                                                        </div>                                             
                                                        <div class="col-md-6 mb-20">
                                                            <label class="mb-2 font-fifteen font-500">Target</label><span> (in numbers.)</span>
                                                            <input class="form-control" name="target" type="number" value="<?= $data['target']; ?>" required>
                                                        </div>
                                                        <div class="col-md-6 mb-20">
                                                            <label class="mb-2 font-fifteen font-500">Total Amount Raised</label><span> (in numbers.) Default is &#x20A6;0.00</span>
                                                            <input class="form-control" id="price" name="amount_raised" value="<?= $data['amount_raised']; ?>" type="number">
                                                        </div>                                                               
                                                        
                                                        <div class="col-xl-12 col-lg-12 col-md-12">
                                                            <button type="submit" name="edit_project_btn" class="btn btn-primary">Edit Project</button>
                                                        </div>
                                                    </div>                                        
                                                </div>
                                            </div>
