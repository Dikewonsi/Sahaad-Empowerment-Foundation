...
<head>
    ...
    <title>Sahaad Empowerment Foundation - Delete Members</title>
    <!-- Favicon -->
                ...
                <div class="col-md-8 col-lg-9 col-xl-10 px-0 dashboard-body" style="height: 100vh; overflow-y: scroll;">
                    ...
                    <div class="full-row px-40 py-30 xs-p-0">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col">
                                    <h3 class="my-3">Delete Member</h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                            ...
                                            <table class="w-100 items-list bg-transparent">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><?= $rows['name']; ?></td>
                                                        <td><?= $rows['role']; ?></td>
                                                        <td><img src="members/<?= $rows['image'];?>" alt=""></td>
                                                        <td><?= $rows['date_added'];?></td>
                                                        <td><?= $rows['date_modified'];?></td>
                                                        <td>
                                                            <a href="delete-member-page.php?id=<?= $rows['id']; ?>" class="text-primary me-4 mb-1"><i class="fas fa-trash"></i></a>                                                            
                                                        </td>
                                                    </tr>  
                                                    <?php
                                                        }
