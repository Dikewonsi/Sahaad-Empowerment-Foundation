    ...
    <div id="targetElement" class="sidebar-area sidebar__hide">
        ...
        <ul class="info pt-40">
            <li class="py-2">
                ...
                <a href="tel:+2348101086263">+234 810 1086 263</a>
            </li>
        ...
        <div class="social-icon mt-20">
            ...
            <a href="https://www.instagram.com/sahaadfoundation?igsh=MTBqMzB4ejNkNGN3aw=="><i class="fa-brands fa-instagram"></i></a>  
        ...
        <div style="margin-top:20px;">
            <a href="donate.php" class="btn-inner">
                <span class="btn-text" style="background-color:#f74f22; color:white; border:#f74f22; padding:5px;">
                    DONATE NOW
                </span>
            </a>
        </div>
